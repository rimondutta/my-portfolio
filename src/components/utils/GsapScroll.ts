...
let sectionTimelinesReady = false;

export function setCharTimeline(
  character: THREE.Object3D<THREE.Object3DEventMap> | null,
  camera: THREE.PerspectiveCamera
) {
  // Always ensure section timelines like "What I Do" are registered
  setupSectionTimelines();
...
export function setupSectionTimelines() {
  if (sectionTimelinesReady) return;
  sectionTimelinesReady = true;
