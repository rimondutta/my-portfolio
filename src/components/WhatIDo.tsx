        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DevOps</h3>
              <h4>Deploy. Monitor. Improve.</h4>
              <p>
                I manage scalable infrastructure, automate deployments, and ensure reliable software delivery using industry-standard DevOps tools and practices.
              </p>
